...
#include <memory>
#include "../../ai_trial/inputdialog.h"
...
Q_CONSTINIT static const qt_meta_stringdata_InputDialog_t qt_meta_stringdata_InputDialog = {
    {
        ...
        QT_MOC_LITERAL(12, 13),  // "inputFinished"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 4),  // "text"
        QT_MOC_LITERAL(32, 17)   // "onOKButtonClicked"
    },
    "InputDialog",
    "inputFinished",
    "",
...
void InputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->inputFinished((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &InputDialog::inputFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputDialog::inputFinished(const QString & _t1)
{
