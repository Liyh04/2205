...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        b_avi->setGeometry(QRect(640, 570, 111, 20));
        w_avi = new QLabel(Widget);
        w_avi->setObjectName("w_avi");
        w_avi->setGeometry(QRect(860, 570, 111, 20));
