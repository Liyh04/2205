...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        Widget->resize(1501, 600);
        layoutWidget = new QWidget(Widget);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(1000, 60, 451, 423));
        ...
        lcd_sec->setGeometry(QRect(880, 70, 81, 71));
        ...
        layoutWidget_2->setGeometry(QRect(830, 180, 114, 245));
        ...
        label_3->setGeometry(QRect(835, 150, 111, 23));
        ...
        lcd_min->setGeometry(QRect(800, 70, 81, 71));
